      ...
      <div className="max-w-7xl w-full mx-auto px-6 flex justify-between items-center">
        ...
        <div className="flex items-center gap-8">
          ...
          <button
            ...
            className="w-8 h-8 flex items-center justify-center rounded-full border border-white/30 dark:border-[#c89b3c]/50 text-white hover:border-[#f1c40f] hover:text-[#f1c40f] transition-all text-base"
          >
            {theme === 'dark' ? '☀️' : '🌙'}
          </button>
        </div>
