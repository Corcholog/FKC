...
import { loadSeries } from "@/lib/team/queries";
import { authorsByUserId, labelAuthors, notesByGame, threadNotes } from "@/lib/team/notes";
import { TeamSeriesView } from "@/components/team/views/series-view";
import { DeleteSeriesButton } from "@/components/team/delete-series-button";
...
export default async function TeamSeriesPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    <TeamSeriesView
      ...
      actions={
        <div className="flex items-center gap-1">
          <Link
            href={`/team/matches/${series.id}/edit`}
