...
// The same page as /team/roster, against the demo views. It was /demo itself
// until the dashboard landed; the cache key stays "roster" because the loader
// behind it hasn't changed.
export default async function DemoTeamRosterPage() {
  ...
  // No <main> and no heading: /demo/team/layout.tsx owns both.
  return (
