...
import { suggest, resolveUnique } from "@/lib/champion-search";
...
//
// The search/resolution rules themselves live in lib/champion-search.ts, which
// this re-exports so nothing that imported them from here has to move.
export { suggest, resolveUnique } from "@/lib/champion-search";
