...
// Draft aggregates across every recorded game — /scrims/drafts and its demo.
//
...
// right, the demo_scrim_* views are wired up correctly, with no aliasing in the
...
export function ScrimDraftsView({
  games,
  version,
  championMap,
}: {
