...
import { BANS_PER_SIDE, TEAM_ROLES, type TeamRole } from "@/lib/team/types";
...
import { ReplayGameButton } from "@/components/team/replay-drop";
...
export function TeamGameFields({
  game,
  index,
  roster,
  champions,
  ...
  const patchPick = (ally: boolean, role: TeamRole, patch: Partial<PickState>) => {
