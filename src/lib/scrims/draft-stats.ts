...
//
// The most useful half of scrim tracking: a draft pattern is what you actually
 ...
 * byGamesThenRecord and byWinRateThenGames take, so scrim champion lists sort
 ...
 */
export function aggregatePicks(games: ScrimGameView[], side: DraftSide): ChampionPickAgg[] {
 ...
 */
export function countBans(games: ScrimGameView[], by: DraftSide): ChampionBanCount[] {
 ...
 */
export function championPresence(games: ScrimGameView[]): ChampionPresence[] {
 ...
 */
export function championsUsedInSeries(games: ScrimGameView[]): Set<number> {
