// Reading a .rofl — a League replay — for the numbers a scrim form otherwise
...
/** Which team a player was on. Mirrors ScrimSide without importing it, so this stays dependency-free. */
